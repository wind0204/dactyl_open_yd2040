...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [SECOND_LAYER] = LAYOUT_5x7(
        ...
        _______,   _______,   _______,   _______,   _______,   _______,  _______,
        _______,   _______,   _______,   MS_BTN2,   MS_BTN1,   MS_BTN3,  _______,
    ...
    [THIRD_LAYER] = LAYOUT_5x7(
        // left hand
        KC_SCROLL_LOCK, KC_F1, KC_F2 ,   KC_F3  ,   KC_F4  ,   KC_F5  ,  KC_F6  ,
        _______,   _______,   _______,   KC_UP  ,   _______,   _______,  _______,
        KC_NUM ,   KC_APP ,   KC_LEFT,   KC_DOWN,   KC_RGHT,   _______,  _______,
        _______,   _______,   _______,   _______,   _______,   _______,
        KC_LNG2,   _______,   _______,   _______,   _______,             _______, _______,
                                                                _______, _______, _______,
        // right hand ( inversed )
